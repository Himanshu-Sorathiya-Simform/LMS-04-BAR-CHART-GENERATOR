...
const Bar = memo(function Bar({
	...
	return (
		<button
			className="flex h-full flex-col items-center justify-end border-2 border-transparent transition hover:bg-blue-100 focus:border-neutral-300 focus:bg-blue-100 focus:outline-0"
